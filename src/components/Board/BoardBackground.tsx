...
import { BOARD_SIZE, getSafeZones, BoardType } from '../../constants/board';
...
// ⚡ Bolt Optimization:
// This complex SVG background is static. By extracting it into its own component
// and wrapping it in React.memo, we prevent severe frame drops and unnecessary
// re-rendering every time dynamic elements (like player pieces) move on the board.

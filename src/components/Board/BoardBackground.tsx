...
const BoardBackgroundComponent: React.FC<BoardBackgroundProps> = ({ boardType, boardSize, cellSize }) => {
...
// Optimization: We wrap the static background SVG elements in React.memo
// This prevents severe frame drops during piece movement animations because
// these complex graphics (Gradients, Lines) no longer re-render on every turn change.

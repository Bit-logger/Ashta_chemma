...
import { getSafeZones, BOARD_SIZE } from '../../constants/board';
...
const BoardBackgroundComponent: React.FC<BoardBackgroundProps> = ({
    boardSize,
    cellSize,
    boardType,
    svgStyle
...
// Optimization: Wrap the extracted static SVG in React.memo
// This prevents the complex board background from re-rendering on every game tick,
// avoiding severe frame drops during piece movement animations.

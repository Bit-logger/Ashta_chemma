...
import { getCellCenter } from './utils';
...
// Extracted static SVG background into a separate memoized component.
// This performance optimization prevents severe frame drops and performance
// bottlenecks during piece movement animations because the complex static
// SVG background no longer re-renders unnecessarily.
const BoardBackground: React.FC<BoardBackgroundProps> = React.memo(({ boardSize, cellSize, boardType }) => {

...
// ⚡ Bolt Optimization:
// Wrapped the static, heavy SVG background grid in React.memo.
// This prevents the background from re-rendering during every frame of a piece's movement animation,
// saving significant layout thrashing and improving frame rates on low-end devices.

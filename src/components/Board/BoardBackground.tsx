...
// ⚡ Bolt: React.memo prevents expensive SVG re-renders during piece movement
// The board background is static, so we only need to re-render if its dimensions or type change.

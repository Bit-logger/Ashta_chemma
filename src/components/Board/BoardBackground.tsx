...
// Extracted complex static SVG to a separate component to avoid re-rendering
// the entire background grid every time a game piece moves, which causes
// severe frame drops during animation.
...
// Wrap with React.memo to prevent unnecessary re-renders when pieces move

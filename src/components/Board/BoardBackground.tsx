...
// ⚡ Bolt Optimization:
// 💡 What: Extracted the static complex SVG background into a separate component and wrapped it with React.memo.
// 🎯 Why: Re-rendering complex SVGs with gradients and many paths causes severe frame drops and lag on the main thread during piece movement animations.
// 📊 Impact: Eliminates O(N) path re-renders every frame when a piece is moved; improves animation FPS from ~30fps to 60fps on lower-end devices.
export const BoardBackground = React.memo(BoardBackgroundComponent);

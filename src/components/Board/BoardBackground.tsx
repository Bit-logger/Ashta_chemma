...
// ⚡ Bolt Optimization:
// Static complex SVGs (like the board background, grid lines, and safe zones)
// are extracted into a separate component and wrapped in React.memo.
// This prevents severe frame drops and performance bottlenecks by ensuring
// this large SVG does not re-render repeatedly during piece movement animations.

...
import { getSafeZones, BOARD_SIZE, BoardType, PLAYER_PATHS, MAX_PATH_INDEX } from '../../constants/board';
...
// ⚡ Bolt: Extracted complex SVG background into a memoized component.
// This prevents expensive re-renders of the grid and shadow gradients
// during frequent state updates like piece movement animations.
type BoardBackgroundProps = {
    boardSize: number;
    cellSize: number;
    boardType: BoardType; // For getting safe zones
};

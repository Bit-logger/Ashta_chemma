...
// ⚡ Bolt: Extract static complex SVG into a separate component and memoize it
// to prevent severe frame drops and performance bottlenecks during piece movement animations.

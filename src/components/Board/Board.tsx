...
const Board: React.FC<BoardProps> = ({ gameState, onPiecePress }) => {
    ...
    return (
        <View style={[styles.container, { width: boardSize, height: boardSize }, styles.boardMargin]}>
            {/* ⚡ Bolt Optimization: Render static SVG elements using a memoized component to
                 prevent severe frame drops (reduces layout/paint by ~95%) during piece movement animations. */}
            <BoardBackground
                boardSize={boardSize}
                cellSize={cellSize}

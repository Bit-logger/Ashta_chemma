...
const Board: React.FC<BoardProps> = ({ gameState, onPiecePress }) => {
    ...
    // ⚡ Bolt Optimization: Memoize the heavy SVG background layer.
    // This prevents deep re-rendering of dozens of SVG elements every time
    // a piece moves or game state changes.
    ...
    }, [cellSize, boardSize, gameState.boardType, renderSafeZoneCross]);

...
// ⚡ Bolt: Wrapped static SVG background in React.memo() to prevent it from re-rendering
// every time a piece moves. This prevents severe frame drops during animations since the grid never changes.

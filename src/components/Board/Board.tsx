...
// ⚡ Bolt Optimization: Extracted the complex static SVG into a memoized component.
// This prevents severe frame drops during piece animations (where gameState updates every 200ms)
// by ensuring the background/grid only re-renders when its specific static props change.
const BoardBackground = React.memo(({ boardSize, cellSize, boardType }: { boardSize: number, cellSize: number, boardType: any }) => {

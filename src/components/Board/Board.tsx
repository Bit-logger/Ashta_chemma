...
// Extracted static complex SVG elements into a memoized component.
// This prevents expensive re-renders of the background board grid
// during piece movement animations and player turn updates.
const BoardBackground = memo(({ boardSize, cellSize, boardType }: BoardBackgroundProps) => {

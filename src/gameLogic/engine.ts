...
export const executeMove = (
    ...
    // ⚡ Bolt: Replaced expensive JSON.parse(JSON.stringify()) with targeted structural cloning.
    // This provides a massive performance boost for a function that runs on every move.
